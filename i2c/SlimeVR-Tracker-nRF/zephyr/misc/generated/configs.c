...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USER_EXTRA_ACTIONS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PROMICRO_UF2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PROMICRO_UF2_NRF52840_I2C, 1);
